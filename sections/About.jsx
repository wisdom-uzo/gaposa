  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div
      ...
      <motion.div
        ...
        The School of Science and Technology, Gateway (ICT) Polytechnic Saapade, Ogun state, Nigeria is excited to announce the maiden edition of her <strong>International Conference on Science and Technology</strong>. <br />
         The Conference presents a unique opportunity to everyone concerned with the Sustainability of the National growth of Nigeria and other nationals who can get ideas and information for growth and sustainable development of their own nations. Hence, this maiden edition holding between the 30th May - 1st June, 2023 at the Leadership Development Centre, Gateway Polytechnic Saapade, Ogun state, Nigeria shall revolve around the theme: <strong>“Attaining National Sustainability Through Science and Technology.”</strong> 
      </p>
      <p className="text-gray-700 leading-relaxed mb-8">
        Researchers, Science and Technology experts, players in different fields of Science and Technology, policymakers, and individuals are therefore invited to come together and share their insights, works, findings, interests and experiences with one another at the upcoming Conference. <br /> The Conference will feature Keynote, presentations, panel discussions, and workshops on latest research, policy, and practice revolving around the theme as here highlighted.
      </p>
      <p className="text-gray-700 leading-relaxed mb-8">
